...
#define nbRate 2. //interarrivl time of northbound vehicles
#define sbRate 2.1 //interarrival time of southbound vehicles
...
//////////////////////////////////////////////////////
 int main(void) {
	...
	printf ("Number of vehicles that departed from North= %d\n", nDepN);
	printf ("Number of vehicles that departed from South= %d\n", nDepS);
